...
def load_music_current_9222022():
    f = open('data/archive/music/9222022/music_current.json')
    data = json.load(f)
    return data

@app.route("/data/archive/music/9222022/music_current_songs.json")
def load_music_current_songs_9222022():
    f = open('data/archive/music/9222022/music_current_songs.json')
    data = json.load(f)
    return data

@app.route("/archive/music/15")
def music_archive_9222022():
    avg_score = 9.35
    total_tracks = 84
    total_albums = 5
...
def load_music_current_1232022():
    f = open('data/archive/music/1232022/music_current.json')
    data = json.load(f)
    return data

@app.route("/data/archive/music/1232022/music_current_songs.json")
def load_music_current_songs_1232022():
    f = open('data/archive/music/1232022/music_current_songs.json')
    data = json.load(f)
    return data

@app.route("/archive/music/16")
