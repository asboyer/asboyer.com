...
top = ['Kanye West', 'Playboi Carti', 'Frank Ocean', 'Lil Uzi Vert', 'Michael Jackson', 'Post Malone', 'Don Toliver', 'Childish Gambino', 'Taylor Swift', 'Drake', 'Drake, Future', 'Travis Scott']
